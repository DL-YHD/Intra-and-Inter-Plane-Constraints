...
if __name__ == '__main__':
    img2_path='./3ddetectionkitti/data_object_image_2/training/image_2/'
    img3_path = './3ddetectionkitti/data_object_image_3/training/image_3/'
    calib_path = './3ddetectionkitti/data_object_calib/training/calib/'
    label_path='./3ddetectionkitti/label/training/label_2/'
    outp='./3ddetectionkitti/kitti_format/'
    test_path='./3ddetectionkitti/data_object_image_2/testing/image_2/'
